...
{% highlight text %}
## Error in levels(datt$PMD) = list(P = "P", M = "M", D = "D"): object 'datt' not found
{% endhighlight %}
...
{% highlight text %}
## Error in ggplot(datt, aes(x = Area, color = PMD, fill = PMD)): object 'datt' not found
{% endhighlight %}
...
{% highlight text %}
## Error in ggplot(datt, aes(x = PMD, y = Area, fill = PMD)): object 'datt' not found
{% endhighlight %}
...
{% highlight text %}
## Error in eval(expr, envir, enclos): object 'datt' not found
{% endhighlight %}
...
{% highlight text %}
## Error in names(dat) = c("Sample ID", "# in image", "image No.", "image name", : object 'dat' not found
{% endhighlight %}
...
<iframe style='position: relative' src="{{ site.baseurl }}/widget/dat.html"  frameborder="0" width="100%" height="400" allowfullscreen="allowfullscreen"></iframe>
